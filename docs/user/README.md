...
# local_taskflow — User documentation

Index of the user and admin documentation chapters of **Wunderbyte Taskflow**. Start with [Getting started](getting_started/README.md) if you are new to the plugin.
...
| Change the status or due date of an assignment, add a comment | [Edit assignment](assignments/03-edit-assignment.md) |
| Read the audit trail of an assignment | [History](assignments/04-history.md) |
| Understand due dates, activation delay, extension, overdue, paused, dropped out | [Due dates, prolongation, overdue](assignments/05-due-dates-prolongation-overdue.md) |
| Make a training recur (yearly refresher etc.) | [Cyclic assignments](assignments/06-cyclic-assignments.md) |
| Create and manage rules | [Rules](rules/README.md) |
| Fill in the first step of the rule form (who, due date, cyclic, enabled) | [Rule step](rules/01-rule-step.md) |
| Limit a rule to users matching profile-field or date conditions | [Filters](rules/02-filters.md) |
| Define what must be completed (booking option, course, competency) | [Targets](rules/03-targets.md) |
| Attach message templates to a rule and decide when they are sent | [Messages step](rules/04-messages-step.md) |
| Decide per rule which requests employees may raise and who receives them | [Requests step](rules/05-requests-step.md) |
| Understand the message system (templates, sending, notifications, deputies) | [Messages](messages/README.md) |
| Create or edit a message template field by field | [Message templates](messages/01-message-templates.md) |
| Look up a placeholder for a message text | [Placeholders](messages/02-placeholders.md) |
...
| Configure the KSW adapter | [KSW adapter](adapters/ksw.md) |
| Configure the TU Wien INES adapter (nightly DWH import, extension limits) | [TU Wien INES adapter](adapters/tuines.md) |
| Look up an admin setting | [Settings](settings/README.md) |
| Set up roles and permissions | [Capabilities](capabilities/README.md) |
| Understand scheduled and adhoc background tasks, caches | [Scheduled tasks](scheduled_tasks/README.md) |
| Embed dashboards and assignment lists on Moodle pages | [Shortcodes](shortcodes/README.md) |
...
| [Capabilities](capabilities/README.md) | Overview only |
| [Scheduled tasks](scheduled_tasks/README.md) | Overview only |
| [Shortcodes](shortcodes/README.md) | Overview only |

For developer topics (architecture, adapter API, rule JSON format) see the [developer guides](../developer-guides/ARCHITECTURE_OVERVIEW.md).
