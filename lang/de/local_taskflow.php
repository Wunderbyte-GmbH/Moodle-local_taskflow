...
$string['dashboard:supervisor'] = 'Ansicht Vorgesetzter';
$string['date'] = 'Datum';
...
$string['pendingapprovals'] = '<i class="fas fa-check-circle"></i> Offene Genehmigungen';
...
$string['supervisor:external'] = 'Vorgesetzter interne Moodle id';
