...
$string['chooseuser'] = 'Benutzer auswählen...';
...
$string['eventrulecreatedupdated'] = 'Regel aktualisiert oder erstellt';
$string['eventrulecreatedupdateddescription'] = 'Eine Regel wurde aktualisiert oder erstellt';
$string['eventunitmemberremoved'] = 'Einheitsmitglied entfernt';
$string['eventunitmemberremoveddescription'] = 'Einheitsmitglieder wurden entfernt';
...
$string['eventunitrelationremoved'] = 'Einheitsbeziehung entfernt';
$string['eventunitrelationremoveddescription'] = 'Einheitsbeziehungen wurden entfernt';
$string['eventunitrelationupdated'] = 'Einheitsbeziehung aktualisiert oder erstellt';
$string['eventunitrelationupdateddescription'] = 'Eine Einheitsbeziehung wurde aktualisiert oder erstellt';
$string['eventunitremoved'] = 'Einheit entfernt';
$string['eventunitremoveddescription'] = 'Eine Einheit wurde entfernt';
$string['eventunitupdated'] = 'Einheit aktualisiert oder erstellt';
$string['eventunitupdateddescription'] = 'Eine Einheit wurde aktualisiert oder erstellt';
$string['filter'] = 'Filter';
$string['filtertype'] = 'Filtertyp';
$string['filteruserfield'] = 'Moodle User Filter';
$string['filteruserfieldfirstaccess'] = 'Erstzugang';
$string['filteruserfieldlastaccess'] = 'Letzter Zugang';
...
$string['settingparentinheritance'] = 'Regel von übergeordneter Einheit erben';
...
$string['unitrule'] = 'Regel für Organisationseinheit';
$string['userfield'] = 'Moodle User Field';
$string['userprofilefield'] = 'Benutzerprofilfeld';
$string['value'] = 'Wert';
$string['vueroutenotfoundsitebtnreload'] = 'Zur Hauptseite weiterleiten';
$string['vueroutenotfoundsitedescription'] = 'Weiterleitung zur Hauptseite';
