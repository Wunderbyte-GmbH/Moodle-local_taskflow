...
$string['function'] = 'Assign function to: ';
...
$string['mappingdescription'] = 'Explination taskflow label-value pairs';
$string['mappingdescription_desc'] = 'Here the mapping is created. The upper field indicates which JSON key should be linked to the user profile field. The lower field specifies the function that this field represents. Not every user profile field needs to have a function';
