...
$string['apisettings'] = "Standard API Settings";
$string['apisettings_desc'] = "Configure taskflow key-value pairs.";
$string['archive'] = 'Archive';
$string['assignmentsavailablemy'] = '<a href="{$a}">There are open standard trainings to complete.</a>';
$string['assignmentsavailablesupervisor'] = '<a href="{$a}">There are open clarification cases to be resolved in the standard trainings.</a>';
