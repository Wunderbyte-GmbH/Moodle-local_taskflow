...
namespace taskflowadapter_standard\usecases\statuschanges;
...
final class nora_notrelevant_test extends advanced_testcase {
    ...
    public function test_nora_notrelevant(): void {
        ...
        $usernora = $DB->get_record('user', ['lastname' => 'Nointerest']);
        $usersboss = $DB->get_record('user', ['lastname' => 'Boss']);
        cohort_add_member($cohort->id, $usernora->id);
        cohort_add_member($cohort->id, $usersboss->id);
    ...
    /**
     * Set cohort in the database for testing.
     *
     * @return mixed
     *
     */
