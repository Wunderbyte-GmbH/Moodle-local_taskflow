...
namespace taskflowadapter_standard\usecases\competencies;
...
final class fillipp_filter_test extends advanced_testcase {
     ...
     * @return object
     */
    protected function set_db_second_cohort(): mixed {
        $cohort = $this->getDataGenerator()->create_cohort([
            'name' => 'Test Cohort 2',
            'idnumber' => 'cohort456',
            'contextid' => context_system::instance()->id,
    ...
    public function test_chris_change($bdata): void {
        ...
        cohort_remove_member($cohort->id, $userchrisid);
        cohort_add_member($secondcohort->id, $userchrisid);
