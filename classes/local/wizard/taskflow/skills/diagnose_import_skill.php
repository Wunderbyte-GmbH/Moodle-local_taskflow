    ...
    protected function define_schema(): array {
        return [
            ...
            'description' => 'Diagnose the taskflow HR data import: the feed of persons, units and supervisors that the active '
                . 'adapter loads into taskflow. It reports which adapter is active, when its scheduled import task last ran, the '
                . 'import errors logged since a given date, adapter fields (translator functions) without a mapped profile field, '
                . 'unit members without a supervisor, user accounts suspended by the import, and organisational units without '
