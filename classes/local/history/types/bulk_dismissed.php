...
/**
 * bulk_dismissed type to manage output history.
 *
 ...
 * bulk_dismissed type to manage output history.
 */
class bulk_dismissed extends base {
    /**
    ...
    public function render_additional_data(): string {
        ...
        return taskflow_stringmanager::get_string('bulkdismissed:messagename', $messagename);
    }
