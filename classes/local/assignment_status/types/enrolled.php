 ...
 * @license http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class enrolled extends assignment_status_base {
    /** @var enrolled */
    private static ?enrolled $instance = null;
     ...
     * @return enrolled
     */
    public static function get_instance(): enrolled {
        if (self::$instance === null) {
            self::$instance = new enrolled();
        }
