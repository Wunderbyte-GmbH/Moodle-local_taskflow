 ...
 * @license http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class reprimand extends assignment_status_base {
    /** @var prolonged */
    private static ?reprimand $instance = null;
     ...
     * @return reprimand
     */
    public static function get_instance(): reprimand {
        if (self::$instance === null) {
            self::$instance = new reprimand();
        }
