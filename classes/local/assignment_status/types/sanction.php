 ...
 * @license http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class sanction extends assignment_status_base {
    /** @var prolonged */
    private static ?sanction $instance = null;
     ...
     * @return prolonged
     */
    public static function get_instance(): sanction {
        if (self::$instance === null) {
            self::$instance = new sanction();
        }
