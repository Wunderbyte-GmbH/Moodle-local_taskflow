...
/**
 * Base class for a single taskflow option availability condition.
 *
...
/**
 * Base class for a single taskflow rule condition.
 *
 * All taskflow rule conditions must extend this interface.
 *
 * @package local_taskflow
...
interface taskflow_rule_condition {
     ...
     * @param string $json a json string for a taskflow rule condition
     */
