...
/**
 * Base class for a single taskflow option availability action.
 *
...
use local_taskflow\taskflow_option_settings;
use MoodleQuickForm;
use stdClass;

/**
 * Base class for a single taskflow rule action.
 *
 * All taskflow rule actions must extend this interface.
 *
 * @package local_taskflow
 ...
 * @license http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
interface taskflow_rule_action {
     ...
     * @param string $json a json string for a taskflow rule action
     */
