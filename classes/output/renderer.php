...
class renderer extends plugin_renderer_base {
     ...
     * @return string|bool
     */
    public function render_userstatscard(templatable $class) {
        $data = $class->export_for_template($this);
        return $this->render_from_template('local_taskflow/dashboards/dashboard_userstats', $data);
    }
     ...
     * @return string|bool
     */
    public function render_requestsdashboard(templatable $class) {
        $data = $class->export_for_template($this);
        return $this->render_from_template('local_taskflow/dashboards/dashboard_requests', $data);
    }

    /**
     * Render requests dashboard for hr.
     *
     * @param templatable $class
     * @return string|bool
     */
    public function render_requestsdashboardhr(templatable $class) {
        $data = $class->export_for_template($this);
        return $this->render_from_template('local_taskflow/dashboards/dashboard_requests', $data);
    }
}
