...
class taskflowadapter extends base {
    ...
    /**
     * TRANSLATOR_USER_DEPUTY
     *
     * @var string
     */
    public const TRANSLATOR_USER_DEPUTY = 'translator_user_deputy';
    /**
     * TRANSLATOR_USER_SUPERVISOR
     *
     * @var string
     ...
     * @var string
     */
    public const TRANSLATOR_USER_CONTRACTSTART = 'translator_user_contractstart';
    /**
