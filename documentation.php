...
require_capability('local/taskflow:viewdocumentation', $context);
...
$PAGE->set_url(new moodle_url('/local/taskflow/documentation.php', ['file' => $file]));
$PAGE->set_pagelayout('standard');
$PAGE->set_title(get_string('documentation', 'local_taskflow') . ': ' . $page['title']);
$PAGE->set_heading(get_string('documentation', 'local_taskflow'));

echo $OUTPUT->header();
echo html_writer::div($page['html'], 'local_taskflow-documentation');
echo $OUTPUT->footer();
