...
final class editassignment_test extends advanced_testcase {
    ...
    public function test_export_for_template_returns_constructor_data(): void {
        ...
        $assignment = (object)[
            ...
            'unitid' => $rule->unitid,
            'messages' => '',
            'targets' => '[{"targettype":"bookingoption","targetid":"2","sortorder":2,"targetname":"pf2346 - KONDITIONSTRAINING UND SPIELE","actiontype":"enroll",
            "completionstatus":0,"completebeforenext":false},{"targettype":"bookingoption","targetid":"2","sortorder":2,"targetname":"pf2346 - KONDITIONSTRAINING
            UND SPIELE","actiontype":"enroll","completionstatus":0, "completebeforenext":false, "completionstatus":1}]',
            'assigneddate' => time(),
            'duedate' => time() + 3600,
            'status' => 1,
            'active' => 1,
