...
/**
 * Tests nowminusdays_filter for taskflowrules.
 *
 ...
 */
final class nowminusdays_filter_test extends advanced_testcase {
    /**
     * Tests set up.
     */
    ...
    public function test_now_minus_days_filter(): void {
        ...
        $userdata = [
            $user1->id => [
                $fieldid => 'AB',
                $fieldid2 => strtotime('today'),
            ],
            $user2->id => [
                $fieldid => 'XY',
                $fieldid2 => strtotime('tomorrow'),
            ],
            $user3->id => [
                $fieldid => 'YY',
                $fieldid2 => strtotime('yesterday'),
            ],
        ];
