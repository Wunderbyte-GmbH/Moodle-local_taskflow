 ...
 */
final class competency_earned_test extends advanced_testcase {
    /**
     ...
     * @covers \local_taskflow\local\history\types\competency_earned
    ...
    public function test_has_additional_data_always_returns_true(): void {
        ...
        $change = new competency_earned('rule_change', $json);
