 ...
 */
final class history_event_test extends advanced_testcase {
    /**
    ...
    public function test_history(): void {
        ...
        // Call get_history.
        $results = history::get_history($assignment->id);
        ...
        [$select, $from, $where, $params] = history::return_sql($assignment->id, $user->id, history::TYPE_MESSAGE, 10);
