...
$capabilities = [
    ...
    'local/taskflow:vieworganisation' => [
        'captype' => 'read',
        'contextlevel' => CONTEXT_SYSTEM,
        'archetypes' => [
            'manager' => CAP_ALLOW,
    ...
    'local/taskflow:uploaduserevidence' => [
        'riskbitmask' => RISK_DATALOSS,
        'captype' => 'write',
        'contextlevel' => CONTEXT_SYSTEM,
        'archetypes' => [
    ...
    'local/taskflow:downloaddashboard' => [
        'riskbitmask' => RISK_DATALOSS,
        'captype' => 'read',
        'contextlevel' => CONTEXT_SYSTEM,
        'archetypes' => [
    ...
    'local/taskflow:viewdocumentation' => [
        'captype' => 'read',
        'contextlevel' => CONTEXT_SYSTEM,
        'archetypes' => [
                'manager' => CAP_ALLOW,
